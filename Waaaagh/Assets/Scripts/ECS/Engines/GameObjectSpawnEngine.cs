...
{
    public class GameObjectSpawnEngine : ReactToRowEngine<IHaveGameObject, GameObjectComponent>
    {
        ...
        protected override void Add(ref GameObjectComponent instance, IEntityTable<IHaveGameObject> table, uint entityID)
        {
            instance.instanceID = _goManager.Create(instance.prefabID);
        }

        protected override void Remove(ref GameObjectComponent instance, IEntityTable<IHaveGameObject> table, uint entityID)
        {
